...
App_Cpp_Files := $(UNTRUSTED_DIR)/sample.cpp $(UNTRUSTED_DIR)/MyFile.cpp# $(wildcard App/TrustedLibrary/*.cpp)
...
$(UNTRUSTED_DIR)/Main_u.c: $(SGX_EDGER8R) $(TRUSTED_DIR)/Main.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../$(TRUSTED_DIR)/Main.edl --search-path ../$(TRUSTED_DIR) --search-path $(SGX_SDK)/include
	@echo "GEN  =>  $@"

$(UNTRUSTED_DIR)/Main_u.o: $(UNTRUSTED_DIR)/Main_u.c
	@$(CC) $(App_C_Flags) -c $< -o $@
	@echo "CC   <=  $<"
...
sample: $(UNTRUSTED_DIR)/Main_u.o $(App_Cpp_Objects)
...
clean:
	@rm -f sample  $(App_Cpp_Objects) $(UNTRUSTED_DIR)/Main_u.* 
